...
//  **参照ゼロの独立 asmdef**（Origuma.EasyPBR.URP.Installer）に分離してあり、
...
namespace Origuma.EasyPBR.URP.Installer
{
    public class EasyShaderCoreInstaller : EditorWindow
    {
        private const string PackageDisplayName = "EasyPBR";
        private const string WindowTitle = "EasyPBR Setup";
